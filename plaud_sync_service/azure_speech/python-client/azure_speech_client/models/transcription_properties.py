...
class TranscriptionProperties(object):
    ...
    def __init__(self, word_level_timestamps_enabled=None, display_form_word_level_timestamps_enabled=None, duration=None, channels=None, destination_container_url=None, punctuation_mode=None, profanity_filter_mode=None, time_to_live=None, email=None, error=None, diarization_enabled=None, diarization=None, language_identification=None, _configuration=None):  # noqa: E501
