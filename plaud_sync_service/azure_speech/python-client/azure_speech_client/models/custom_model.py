...
class CustomModel(object):
    ...
    def __init__(self, links=None, properties=None, project=None, text=None, base_model=None, datasets=None, custom_properties=None, _configuration=None):  # noqa: E501
