...
class DatasetProperties(object):
    ...
    def __init__(self, text_normalization_kind=None, accepted_line_count=None, rejected_line_count=None, duration=None, email=None, error=None, _configuration=None):  # noqa: E501
