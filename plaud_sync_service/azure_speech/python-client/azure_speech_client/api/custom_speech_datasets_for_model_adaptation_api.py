...
class CustomSpeechDatasetsForModelAdaptationApi(object):
    ...
    def datasets_upload(self, display_name, locale, kind, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str display_name: The name of this dataset. (required)
        :param str locale: The locale of this dataset. (required)
        :param str kind: The kind of the dataset. Possible values are \"Language\", \"Acoustic\", \"Pronunciation\", \"AudioFiles\", \"LanguageMarkdown\", \"OutputFormatting\". (required)
