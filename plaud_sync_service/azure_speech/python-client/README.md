...
Python client library for Azure Speech Services API v3.2.

This package provides a comprehensive interface to Azure Cognitive Services Speech API, including transcription, custom models, datasets, endpoints, and webhooks.

**Note:** This package is generated from the Azure Speech Services OpenAPI specification using Swagger Codegen.

- API version: 3.2
- Package version: 3.2.0
- For more information, visit [Azure Speech Services Documentation](https://learn.microsoft.com/azure/cognitive-services/speech-service/support)
...
For local development in the QuickScribe project:
...
# Or after building
azure-speech-client @ file:///path/to/quickscribe/plaud_sync_service/azure_speech/python-client
```
...
api_instance = azure_speech_client.CustomSpeechDatasetsForModelAdaptationApi(azure_speech_client.ApiClient(configuration))
id = 'id_example' # str | The identifier of the dataset.
block_list = [azure_speech_client.CommitBlocksEntry()] # list[CommitBlocksEntry] | The list of blocks that compile the dataset.
